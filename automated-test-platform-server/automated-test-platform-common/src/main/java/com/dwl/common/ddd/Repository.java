 ...
 * <p>
 * 仓储负责聚合根的持久化和检索,封装数据访问细节,
 * 仓储接口定义在领域层,实现在基础设施层,仓储只操作聚合根,不操作聚合内的实体
 * <p>
 * Repository is responsible for persistence and retrieval of aggregate roots,
 * encapsulating data access details. Repository interfaces are defined in the
 * domain layer, implementations in the infrastructure layer. Repository only
