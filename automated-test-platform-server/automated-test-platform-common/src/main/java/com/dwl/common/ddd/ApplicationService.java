 ...
 * <p>
 * 应用服务不包含业务规则, 只做: 事务控制、调度聚合根/领域服务、发布领域事件、数据转换(DTO/VO)
 * <p>
 * Controller 只依赖应用服务, 不直接操作领域对象
 * <p>
 * Application Service is the entry point of a bounded context, responsible for
 * orchestrating domain objects to complete use cases
 * <p>
 * Application Services do not contain business rules, they only do: transaction control, dispatching aggregate
